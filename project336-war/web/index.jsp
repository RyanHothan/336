                        ...
                        <div id="ibm-content-main">
                            ...
                            <div class="ibm-columns">
                                ...
                                <div class="ibm-col-6-4">				
                                    ...
                                    <form method="post" action="validateEmail" class="ibm-row-form" name="register" id="registerform">
                                        ...
                                        <div class="ibm-columns">
                                            <div class="ibm-col-2-1">
                                                <p>
                                                    ...
                                                    <span><input name="FName" id="FName" size="36" type="text" value=""></span>
                                                </p>
                                            </div>
                                            <div class="ibm-col-2-1">
                                                <p>
                                                    <label for="LName">Last name:<span class="ibm-required">*</span></label>
                                                    <span><input name="LName" id="LName" size="36" type="text" value=""></span>
                                                </p>
                                            </div>
                                        </div>
                                        <p>
                                            ...
                                            <span><input name="UserID" id="emailAddress" size="42" type="text" value="" onkeyup="validateUserID();" onblur="checkEmail( & #39; emailAddress & #39; );"></span>
                                        ...
                                        <p>
                                            ...
                                            <span><input name="Password" id="Password" size="42" type="password" value="" onkeyup="validatePassword();"> </span>
                                        ...
                                        <p>
                                            ...
                                            <span><input name="RePassword" id="RePassword" size="42" type="password" value="" onkeyup="validateRePassword();"></span>
                                        ...
                                        <p>
                                            ...
                                            <span><input name="alias" id="alias" size="42" type="text" value="" onkeyup="validateDisplayName();" onblur="checkDisplayname( & #39; alias & #39; );"></span>
                                ...
                                <p>
                                    ...
                                    <span><input name="SecurityAns" id="SecurityAns" size="42" type="text" value=""></span>
                                </p>
